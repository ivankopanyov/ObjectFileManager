...
/// <summary>Класс, описывающий команду получения списка системных дисков.</summary>
public class DrivesCommand : Command
{
    ...
    public override string Description => "Список системных дисков.";

    /// <summary>Примеры использования команды.</summary>
    public override string[] Examples => _Examples;

    /// <summary>Инициализация объекта команды получения списка системных дисков.</summary>
    ...
    /// <summary>Выполнение команды получения списка системных дисков.</summary>
